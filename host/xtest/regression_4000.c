...
static const struct xtest_ac_case xtest_ac_cases_ecdsa[] = {
	/* ECDSA tests */
	/* [P-192] with SHA1 hash using legacy algo ID __OPTEE_ALG_ECDSA_P192 */
	XTEST_AC_ECC_CASE(0, __OPTEE_ALG_ECDSA_P192, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_1),
	XTEST_AC_ECC_CASE(0, __OPTEE_ALG_ECDSA_P192, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_1),
	/* [P-192] with SHA1 hash */
	XTEST_AC_ECC_CASE(0, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_1),
	XTEST_AC_ECC_CASE(0, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_1),
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_2),
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_2),
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
	...
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_15),
	/* [P-224] with SHA1 hash using legacy algo ID __OPTEE_ALG_ECDSA_P224 */
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P224, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_16),
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P224, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_16),
	/* [P-224] with SHA1 hash */
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_16),
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_16),
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
	...
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_30),
	/* [P-256] with SHA1 hash using legacy algo ID __OPTEE_ALG_ECDSA_P256 */
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P256, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_31),
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P256, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_31),
	/* [P-256] with SHA1 hash */
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_31),
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_31),
	...
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_45),
	/* [P-384] with SHA1 hash using legacy algo ID __OPTEE_ALG_ECDSA_P384 */
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P384, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_46),
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P384, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_46),
	/* [P-384] with SHA1 hash */
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_46),
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_46),
	...
	XTEST_AC_ECC_CASE(15, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_60),
	/* [P-521] with SHA1 hash using legacy algo ID __OPTEE_ALG_ECDSA_P521 */
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P521, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_61),
	XTEST_AC_ECC_CASE(1, __OPTEE_ALG_ECDSA_P521, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_61),
	/* [P-521] with SHA1 hash */
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_VERIFY,
			  nist_186_2_ecdsa_testvector_61),
	XTEST_AC_ECC_CASE(1, TEE_ALG_ECDSA_SHA1, TEE_MODE_SIGN,
			  nist_186_2_ecdsa_testvector_61),
	...
	for (n = 0; n < ac_cases_count; n++) {
		...
		case TEE_MAIN_ALGO_SM2_DSA_SM3:
			...
			case TEE_ALG_ECDSA_SHA512:
				switch (tv->params.ecc.private_len) {
				case 24:
