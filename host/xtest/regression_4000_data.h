...
/* Wycheproof ecdh_secp224r1_ecpoint_test.json tcId 451 */
static const uint8_t wycheproof_ica_p224_pubkey_x[] = {
...
static const uint8_t wycheproof_ica_p224_pubkey_y[] = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00,
...
/* Wycheproof ecdh_secp256r1_ecpoint_test.json tcId 342 */
static const uint8_t wycheproof_ica_p256_pubkey_x[] = {
...
static const uint8_t wycheproof_ica_p256_pubkey_y[] = {
	0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x01,
	0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
	0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe,
...
/* Wycheproof ecdh_secp384r1_ecpoint_test.json tcId 783 */
static const uint8_t wycheproof_ica_p384_pubkey_x[] = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe,
...
static const uint8_t wycheproof_ica_p384_pubkey_y[] = {
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xfe,
...
/* Wycheproof ecdh_secp521r1_ecpoint_test.json tcId 644 */
static const uint8_t wycheproof_ica_p521_pubkey_x[] = {
...
static const uint8_t wycheproof_ica_p521_pubkey_y[] = {
	0x01, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
...
static struct ecdh_invalid_curve_t {
	uint32_t curve;
	uint32_t keysize;
	...
	size_t public_y_len;
} const derive_key_ecdh_invalid_curve[] = {
	/* [P-224] */
	{
		.curve       = TEE_ECC_CURVE_NIST_P224,
		.keysize     = 224,
		.secret_size = 224,
		.name        = "P-224",
		.public_x  = wycheproof_ica_p224_pubkey_x,
		.public_x_len = sizeof(wycheproof_ica_p224_pubkey_x),
		.public_y  = wycheproof_ica_p224_pubkey_y,
		.public_y_len = sizeof(wycheproof_ica_p224_pubkey_y),
	},
	/* [P-256] */
	{
		.curve       = TEE_ECC_CURVE_NIST_P256,
		...
		.secret_size = 256,
		.name        = "P-256",
		.public_x  = wycheproof_ica_p256_pubkey_x,
		.public_x_len = sizeof(wycheproof_ica_p256_pubkey_x),
		.public_y  = wycheproof_ica_p256_pubkey_y,
		.public_y_len = sizeof(wycheproof_ica_p256_pubkey_y),
	},
	/* [P-384] */
	{
		.curve       = TEE_ECC_CURVE_NIST_P384,
		...
		.secret_size = 384,
		.name        = "P-384",
		.public_x  = wycheproof_ica_p384_pubkey_x,
		.public_x_len = sizeof(wycheproof_ica_p384_pubkey_x),
		.public_y  = wycheproof_ica_p384_pubkey_y,
		.public_y_len = sizeof(wycheproof_ica_p384_pubkey_y),
	},
	/* [P-521] */
	{
		.curve       = TEE_ECC_CURVE_NIST_P521,
		...
		.secret_size = 528,
		.name        = "P-521",
		.public_x  = wycheproof_ica_p521_pubkey_x,
		.public_x_len = sizeof(wycheproof_ica_p521_pubkey_x),
		.public_y  = wycheproof_ica_p521_pubkey_y,
		.public_y_len = sizeof(wycheproof_ica_p521_pubkey_y),
	},
};
